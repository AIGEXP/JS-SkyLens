...
class NetworkThresholdDAOImplTestIT extends BaseTestIT {
    ...
    void save_whenSaving_thenSaveItSuccessfully() {
        ...
        assertThat(entity.getThreshold()).isEqualByComparingTo(networkThreshold.threshold());
    }
    ...
    void save_whenSavingWithSameKey_thenUpdateThreshold() {
        ...
        final BigDecimal newThreshold = BigDecimal.valueOf(0.85);
        ...
        assertThat(entity).isNotNull();
        assertThat(entity.getThreshold()).isEqualByComparingTo(newThreshold);
    }
}
