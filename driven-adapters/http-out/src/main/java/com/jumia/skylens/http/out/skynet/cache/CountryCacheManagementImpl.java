package com.jumia.skylens.http.out.skynet.cache;
...
public class CountryCacheManagementImpl implements CountryCacheManagement {
    ...
    public CountryCacheManagementImpl(final SkyNetProperties skyNetProperties, final CacheManager cacheManager) {

        this.enabled = skyNetProperties.cache().enabled();
