    ...
    violationRules {
        rule {
            ...
            excludes = listOf(
                    ...
                    "com.jumia.skylens.http.in.controllers.ExportOperationsApi",
                    "com.jumia.skylens.http.in.controllers.StopManagementApi",
                    "com.jumia.skylens.http.in.controllers.PackageOperationsApi",
