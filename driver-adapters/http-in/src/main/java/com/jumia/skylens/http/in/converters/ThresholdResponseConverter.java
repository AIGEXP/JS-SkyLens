...
public interface ThresholdResponseConverter extends Converter<NetworkThreshold, ThresholdResponse> {

    @Override
    @Mapping(target = "targetRate", source = "threshold")
    ThresholdResponse convert(NetworkThreshold source);
